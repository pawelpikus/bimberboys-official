        ...
        <div className={styles.gallery_container}>
          ...
          <div className={styles.img_wrapper}>
            ...
            <div className={styles.description}>
              ...
              <p className={styles.desc_text}>
                Zaczynaliśmy jako kwartet ale jedno wolne krzesło (to z butami)
                od początku czekało na Marka i jego perkusję. Przy tym stoliku
                narodziła się niesamowita grupa Bimber Boys! Zdjęcie
          ...
          <div className={styles.img_wrapper}>
            ...
            <div className={styles.description}>
              ...
              <p className={styles.desc_text}>
                Niewielkie knajpki to nasze ulubione miejsca muzycznych spotkań.
                Oczywiście wielkie sceny też mają swój klimat ale w ciasnym
                pubie publiczność jest po prostu bliżej. Bliżej mamy tez do baru
                :)
              </p>
            </div>
          </div>
          ...
          <div className={styles.img_wrapper}>
            ...
            <div className={styles.description}>
              ...
              <p className={styles.desc_text}>
                Kiedy dopada nas twist zamieniamy się instrumentami i dajemy się
                porwać szalonym, muzycznym prądom. Wtedy rodzą się nowe
          ...
          <div className={styles.img_wrapper}>
            ...
            <div className={styles.description}>
              ...
              <p className={styles.desc_text}>
                ...
                wyczarowywać niesamowite dźwięki z gitary, a nawet z mandoliny.
              </p>
            </div>
          </div>
          {/* photo 9 */}
          <div className={styles.img_wrapper}>
            ...
            <div className={styles.description}>
              ...
              <p className={styles.desc_text}>
                ...
                Kiedy nie może nic znaleźć, siada i sam coś pisze. Tutaj zerka w
                górę sprawdzając czy przypadkiem nie spada na niego jakiś
                przebój.
              </p>
            </div>
          </div>
          ...
          <div className={styles.img_wrapper}>
            ...
            <div className={styles.description}>
              ...
              <p className={styles.desc_text}>
                Ukłony dla naszej publiczności, jesteście najlepsi! Kłaniamy się
                pięknie (tak jak kiedyś robili to Beatelsi)! Do zobaczenia na
                koncertach!
              </p>
            </div>
          </div>
