        ...
        <div className={styles.content}>
          ...
          <ol className={styles.ol}>
            ...
            <li>
              ...
              Strony pliki cookies oraz uzyskującym do nich dostęp jest operator
              Strony – Bimber Boys. z siedzibą ul. Wolności 39/59 22-100 Chełm.
              Pliki cookies wykorzystywane są w celu:
            </li>
            <ol type="a">
              <li>
                dostosowania zawartości stron internetowych Strony do
                ...
                urządzenie Użytkownika Strony i odpowiednio wyświetlić stronę
                internetową, dostosowaną do jego indywidualnych potrzeb;
              </li>
              <li>
                tworzenia statystyk, które pomagają zrozumieć, w jaki sposób
                Użytkownicy Strony korzystają ze stron internetowych, co
            ...
            <li>
              W ramach Strony stosowane są dwa zasadnicze rodzaje plików
            ...
            <li>
              ...
              Użytkownika Strony. Szczegółowe informacje o możliwości i
              sposobach obsługi plików cookies dostępne są w ustawieniach
              oprogramowania (przeglądarki internetowej).
            </li>
            <li>
              Operator Strony informuje, że ograniczenia stosowania plików
              cookies mogą wpłynąć na niektóre funkcjonalności dostępne na
              stronach internetowych Strony.
            </li>
            <li>
              Pliki cookies zamieszczane w urządzeniu końcowym Użytkownika
              Strony i wykorzystywane mogą być również przez współpracujących z
